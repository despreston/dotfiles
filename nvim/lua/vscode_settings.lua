...
-- remap these because the neovim vscode extension uses the default vsc ctrl+o
-- and ctrl+i mappings and the vsc jump list includes all open files by
-- default. That behavior differs from the default neovim behavior where ctrl+o
-- and ctrl+i only jump to the previous/next file in the current buffer.
